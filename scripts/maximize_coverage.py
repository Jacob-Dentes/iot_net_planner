...
def main(dem_file, fac_file, prr_file, out_file, budget, min_weight=0.5, inexact_k=10):
    ...
    sol = SCIPModel.solve_coverage(budget, min_weight, dems, facs, prr, blob_size=inexact_k, logging=False)
